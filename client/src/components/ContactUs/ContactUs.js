    ...
    return (
      <div>
        <Modal
          ...
          size="small"
        >
          <Modal.Header floated="left">Contact Us</Modal.Header>
                ...
                >
                  {this.state.errorMsg ? (
                    <Message className="warning" size="large">
                      <Message.Header>{this.state.theMsg}</Message.Header>
                    </Message>
                  ) : null}
                  <Form>
                    <Form.Group>
                    ...
                    <Button
                      type="submit"
                      onClick={this.sendTrashTalksAnEmail}
                      id="sendTrashTalksAnEmailButton"
                    >
        ...
        <Modal
          ...
          size="small"
        >
          <Modal.Header floated="left">Email Has Been Sent!</Modal.Header>
            ...
            <Modal.Description>
              <Message className="positive" size="large">
                <Message.Header>
                  ...
                  <br /> Thank you for emailing us! We will reach out to your
                  shortly.
                </Message.Header>
              </Message>
            </Modal.Description>
